    ...
    this.server.tool(
      ...
      async ({
        ...
        try {
          ...
          const apiUrl = `${API_BASE_URL}/organizations/${organization_slug}/events/?dataset=errors&field=issue&field=title&field=project&field=last_seen%28%29&field=trace&per_page=${limit}&query=${encodeURIComponent(query)}&referrer=sentry-mcp&sort=-last_seen%28%29&statsPeriod=1w`;
