// Generated by Wrangler by running `wrangler types` (hash: d8eb15d04fc016a5bdd4ce499097a1f0)
...
declare namespace Cloudflare {
	interface Env {
		...
		SENTRY_DSN: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/worker/index").SentryMCP>;
		AI: Ai;
	}
}
